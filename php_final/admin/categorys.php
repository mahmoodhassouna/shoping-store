...
<body>
    ...
    <div class="container" style="margin-top:100px">
        ...
        <!-- <a href="addcategory.php" class="btn btn-success float-right">
            Add Category
</a> -->
        <hr />
        <?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
         if(isset($_POST['id'])){
            $delete_query="DELETE FROM category WHERE id = " .$_POST['id'];
    ...
    if($result->num_rows >0){
        while($row = $result->fetch_assoc()){
            ...
            echo'<tr>
               ...
               <a href="http://localhost/m/php_final/admin/editcategory.php ?id= '.$id.'" class="btn btn-xs btn"> edit</a>
